...
LORA_INIT_WEIGHTS="${LORA_INIT_WEIGHTS:-gaussian}"
...
TRAIN_ARGS=(
  ...
  --framework.qwen35.lora.enabled "${USE_LORA}"
  --framework.qwen35.lora.rank "${LORA_RANK}"
  --framework.qwen35.lora.alpha "${LORA_ALPHA}"
  --framework.qwen35.lora.dropout "${LORA_DROPOUT}"
  --framework.qwen35.lora.target_modules "${LORA_TARGET_MODULES}"
  --framework.qwen35.lora.init_lora_weights "${LORA_INIT_WEIGHTS}"
